...
var BaseLayerTable = BaseLayer.extend(
    {
        ...
        ctor: function (){
            ...
            this.addText(this,"_lbTitle",cc.p(640,positionY + 3),this._titleText,UTMBebas.fontName,35);
            ...
            texType =(cc.spriteFrameCache.getSpriteFrame(res_Lobby + "/btnClose_s.png") || texType == ccui.Widget.PLIST_TEXTURE) ? ccui.Widget.PLIST_TEXTURE : ccui.Widget.LOCAL_TEXTURE;
